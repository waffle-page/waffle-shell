import{a as e}from"./instance-BdbpVsCc.js";import{Jt as t}from"./handleFs-I1zVEbgL.js";function n(e){return`COALESCE(LOWER(${e}.content_ref), '') NOT LIKE '%.base'`}function r(e=`t`){return`(
    ${n(e)}
    AND (
