import{a as e}from"./instance-DdgPnDFN.js";import{sr as t}from"./src-CAWBwGif.js";function n(e){return`COALESCE(LOWER(${e}.content_ref), '') NOT LIKE '%.base'`}function r(e=`t`){return`(
    ${n(e)}
    AND (
