import{n as e}from"./rolldown-runtime-QTnfLwEv.js";import{$n as t,er as n,tr as r}from"./src-DQud2GGc.js";import{r as i}from"./opfsFs-Cc5-Hs-W.js";var a=[{version:1,name:`init`,sql:`
-- ── Library ────────────────────────────────────────────────────────────────
...
END;
INSERT INTO content_chunks_fts(content_chunks_fts) VALUES('rebuild');
`},{version:28,name:`remote_only_receipt_projection`,sql:`
ALTER TABLE toppings ADD COLUMN remote_since TEXT;
ALTER TABLE toppings ADD COLUMN remote_original_digest TEXT;
ALTER TABLE toppings ADD COLUMN remote_original_bytes INTEGER;
